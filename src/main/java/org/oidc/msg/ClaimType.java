...
public enum ClaimType {
  BOOLEAN("Boolean", Boolean.class), STRING("String", String.class), INT("Int",
      Integer.class), LIST("List", List.class), ARRAY("Array", Array.class), DATE("Date",
          Date.class), LONG("Long", Long.class), ID_TOKEN("ID_Token", IDToken.class);
